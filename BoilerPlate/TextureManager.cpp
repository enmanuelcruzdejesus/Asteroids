...
void TextureManager::draw(std::string id, int x, int y, int width, int heigth, SDL_Renderer * renderer, SDL_RendererFlip flip)
{
	SDL_Rect srcRect;
	SDL_Rect destRect;
...
void TextureManager::drawFrame(std::string id, int x, int y, int width, int heigth, int currentRow, int currentFrame, SDL_Renderer * renderer, SDL_RendererFlip flip)
{
	SDL_Rect srcRect;
	SDL_Rect destRect;
	srcRect.x = width*currentFrame;
	srcRect.y = heigth *(currentFrame - 1);
	srcRect.w = destRect.w = width;
	srcRect.h = destRect.h = heigth;
	destRect.x = x;
	destRect.y = y;
